    ...
    , ui(new Ui::CShowCurrentChannelWave)
{
	...
	if (!axisY)
	{
		...
		axisY->setRange(-rangeMaxY, rangeMaxY);
...
void CShowCurrentChannelWave::setAxisXName(QString namne)
{
	axisX->setTitleText((namne));
}

void CShowCurrentChannelWave::setAxisYName(QString name)
{
