...
#define PTX_T2TOP_MAX_NUMBER_LOCK_CONTROL   (uint8_t)16u    /**< Maximum number of T2T operation lock controls */
#define PTX_T2TOP_MAX_NUMBER_MEMORY_CONTROL (uint8_t)16u    /**< Maximum number of T2T operation memory controls */
#define PTX_T2TOP_MAX_NUMBER_NDEFTLVS       (uint8_t)16u    /**< T2T NDEF Operations Maximum NDEF TLVs to be handled. */
/** @} */
