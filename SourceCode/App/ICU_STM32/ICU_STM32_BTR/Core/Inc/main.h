...
#define BTR_LOWER 0x08000000
#define BTR_UPPER 0x08001fff
#define BTR_SIZE  0x2000
#define APP_LOWER 0x08002000
#define APP_UPPER 0x08007fff
#define APP_SIZE  0x6000
#define BTR_DATA  0x08001fe0
