...
//const QString ApplicationName = "MindExplorer";
...
//#define SOFTWARE_MAIN_VERSION_NUMBER 0
//#define SOFTWARE_SECONDARY_VERSION_NUMBER 95
...
//const QString ConfigFileXEM7310Tester = "ConfigXEM7310Tester.bit";
//const QString ConfigPionwayRHXController = "ConfigPionwayRHXController.bit";
//
//// NeuroXess Product Type
//const std::string CereCubeDefault = "Default Device";
//const std::string CereCubeM2048 = "CereCube M2048";
//const std::string CereCubeM1024 = "CereCube M1024";
//const std::string CereCubeNsp8 = "CereCube NSP8";
//const std::string CereCubeNsp4 = "CereCube NSP4";
//const std::string CereCubeNsp2 = "CereCube NSP2";
//const std::string CereCubeUnknown = "Unknown Device";
//
...
//const double TwoPi = 6.2831853071795864768;
...
//
//inline SignalType ConvertRhdIntToSignalType(int type)
//{
//    if (type > static_cast<int>(BoardAdcSignal)) type++;
//    return static_cast<SignalType>(type);
//}
//
//inline SignalType ConvertRhsIntToSignalType(int type)
//{
//    return static_cast<SignalType>(type);
//}
//
//inline bool isFloatEqual(const float a, const  float b, const  float d = 0.0001)
//{
//    return fabs(a - b) < d;
//}